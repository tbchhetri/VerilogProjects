...
set_property PACKAGE_PIN U3 [get_ports {test5}]
set_property IOSTANDARD LVCMOS33 [get_ports {test5}]
set_property PACKAGE_PIN P3 [get_ports {test4}]
set_property IOSTANDARD LVCMOS33 [get_ports {test4}]
set_property PACKAGE_PIN N3 [get_ports {test3}]
set_property IOSTANDARD LVCMOS33 [get_ports {test3}]
set_property PACKAGE_PIN P1 [get_ports {test2}]
set_property IOSTANDARD LVCMOS33 [get_ports {test2}]
set_property PACKAGE_PIN L1 [get_ports {test1}]
